...
function createHistoryItem(password) {
  ...
  toggleButton.innerHTML = `
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="eye-off-icon" style="display: none;">
  ...
  toggleButton.addEventListener('click', () => {
    passwordSpan.classList.toggle('visible');
    const eyeIcon = toggleButton.querySelector('.eye-icon');
    const eyeOffIcon = toggleButton.querySelector('.eye-off-icon');
    eyeIcon.style.display = passwordSpan.classList.contains('visible') ? 'none' : 'block';
    eyeOffIcon.style.display = passwordSpan.classList.contains('visible') ? 'block' : 'none';
  });
